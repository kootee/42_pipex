...
/*   Updated: 2024/01/12 10:55:22 by ktoivola         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	close(pipex_args->fd_IO[0]); //close the input file fd
	close(pipex_args->pipe[1]); // this one (write end of pipe) is NOT USED IN PARENT PROCESS!
